...
public class PDFWriterService {
	...
	private final static Logger logger = LoggerFactory.getLogger(PDFWriterService.class);
	 ...
	 * @param args
	 */
	public boolean createPDF(String file) {
		...
		try {
			...
			logger.error(":: Exception in createPDF()  ::", e);
			isError = true;
		} finally {
			if (null != document) {
				document.close();
